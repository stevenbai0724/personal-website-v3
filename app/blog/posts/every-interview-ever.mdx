...
Keywords to look out for in terms of UWaterloo's coop system:
    ...
    - **Not Ranked** = you're absolutely cooked
...
<DropdownContainer>
    <Dropdown title="Wealthsimple (S25 external)">
        ...
        **Round 1: 45 minutes pair programming**
            - Received a week or two after getting a referral. Straightforward OOP problem in Javascript with a challenging, small DSA twist at the end to test algorithmic thinking and problem solving. Passed!

        **Round 2: 30 minutes project demo**
            - A quick 20 mins presentation of a technical project with 10 mins for questions about enhancements, questions about decisions made and difficulties, etc. I presented my work at Algomonster and they seemed to love it!
